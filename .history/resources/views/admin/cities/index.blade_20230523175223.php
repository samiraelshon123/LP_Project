          ...
          <tbody>
            <tr>
                ...
                <tr>
                    ...
                    <td>{{ $city->slug }}</td>
                    <td>{{ $city->icon }}</td>
                    <td>{{ ($city->status == 0)? 'Active':  'InActive'  }}</td>
                    <td>{{ ($city->sub_city != null)? $city->sub_city : 'No city'  }}</td>
                    <td><img src= "{{ $city->image_for_web }}" style="width: 120px; height: 120px;" class="w-50p"/></td>
                    <td style="display: flex;border-bottom: none;">
                        <a class="mr-4" href="{{route('city.edit', $city->id)}}">
