    ...
    <form action="{{route('Page.update', $Page->id) }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="row">
            <div class="form-group col-6">
                ...
                <input type="text" class="form-control" value="{{$Page->name}}" id="exampleInputEmail1" name="name" placeholder="Enter name">
            </div>
            <div class="form-group col-6">
            ...
            <div class="form-group col-6">
                ...
                <input type="text" class="form-control" id="icon" value="{{old('icon', $Page->icon)}}" name="icon" placeholder="Enter Icon">
            </div>
            <div class="form-group col-6">
            ...
            <div class="form-group col-6">
              ...
              <div class="form-group col-6">
                ...
                @foreach($categories as $Page)
                  <option value="{{$Page->id}}" {{($Page->sub_Page == $Page->id)? 'selected': ''}}>{{$Page->name}}</option>
                  @endforeach
                </select>            
              </div>
            <div class="form-group col-6">
