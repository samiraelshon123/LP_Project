    ...
    <form action="{{route('Page.update', $Page->id) }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group col-6">
            ...
            <div class="form-group col-6">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1"  value="{{old('widget_style', $Page->)}}" name="widget_style" placeholder="Enter widget_style">
            </div>
            <div class="form-group col-6">
                <label for="exampleInputEmail1">left_column</label>
                <input type="text" class="form-control" id="left_column" value="{{old('left_column', $Page->)}}" name="left_column" placeholder="Enter left_column">
            </div>
            <div class="form-group col-6">
                <label for="exampleInputEmail1">right_column</label>
                <input type="text" class="form-control" id="right_column" value="{{old('right_column', $Page->)}}" name="right_column" placeholder="Enter right_column">
            </div>
            <div class="form-group col-6">
                <label for="exampleInputEmail1">page_content</label>
                <textarea name="" id="" cols="30" rows="3" name="page_content" >{{old('page_content', $Page->)}}</textarea>            
              </div>
        </div>
        </div>
