        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{route('Pag.index')}}">Pag Table</a></li>
            </ol>
          </div>
        </div>
      </div>
...
<div class="card card-primary" style="width: 100%;">
    ...
    <div class="card-header">
        <h3 class="card-title">Add Pag</h3>
    </div>
             
    <form action="{{route('Pag.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <div class="form-group col-6">
                <label for="exampleInputEmail1">Pag</label>
                <select name="sub_Pag" id="" class="form-control">
                <option value="" disabled selected>Select Pag</option>
                @foreach($categories as $Pag)
