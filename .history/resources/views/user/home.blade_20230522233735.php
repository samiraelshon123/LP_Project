...
<body>
    ...
    <script type="text/javascript" src="{{asset('asset/js/nav/jquery.sticky.js"
    <script type="text/javascript" src="{{asset('asset/js/totop/jquery.ui.totop.js"
    <script type="text/javascript" src="{{asset('asset/js/accordion/accordion.js"
    <script type="text/javascript" src="{{asset('asset/js/rs-plugin/js/jquery.themepunch.tools.min.js"
    <script type="text/javascript" src="{{asset('asset/js/rs-plugin/js/jquery.themepunch.revolution.min.js"
    <script type="text/javascript" src="{{asset('asset/js/maps/gmap3.js"
    <script type="text/javascript" src="{{asset('asset/js/fancybox/jquery.fancybox.js"
    <script type="text/javascript" src="{{asset('asset/js/carousel/carousel.js"
    <script type="text/javascript" src="{{asset('asset/js/filters/jquery.isotope.js"
    <script type="text/javascript" src="{{asset('asset/js/twitter/jquery.tweet.js"
    <script type="text/javascript" src="{{asset('asset/js/flickr/jflickrfeed.min.js"
    <script type="text/javascript" src="{{asset('asset/js/theme-options/theme-options.js"
    <script type="text/javascript" src="{{asset('asset/js/theme-options/jquery.cookies.js"
    <script type="text/javascript" src="{{asset('asset/js/bootstrap/bootstrap.min.js"
    <script type="text/javascript" src="{{asset('asset/js/bootstrap/bootstrap-slider.js"
    <script type="text/javascript" src="{{asset('asset/js/dtb/jquery.dataTables.min.js"
    <script type="text/javascript" src="{{asset('asset/js/dtb/jquery.table2excel.js"
    <script type="text/javascript" src="{{asset('asset/js/dtb/script.js"
    <script type="text/javascript" src="{{asset('asset/js/select2.min.js"
    <script type="text/javascript" src="{{asset('asset/js/jquery.validate.min.js"
    <script type="text/javascript" src="{{asset('asset/js/validation-rule.js"
    <script type="text/javascript" src="{{asset('asset/js/bootstrap3-typeahead.min.js"
    <script type="text/javascript" src="{{asset('asset/js/main.js"
