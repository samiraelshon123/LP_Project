...
<body>
    ...
    <script type="text/javascript" src="{{/js/maps/gmap3.js"></script>
    ...
    <script type="text/javascript" src="{{/js/dtb/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="{{/js/dtb/jquery.table2excel.js"></script>
    <script type="text/javascript" src="{{/js/dtb/script.js"></script>
    <script type="text/javascript" src="{{/js/select2.min.js"></script>
    <script type="text/javascript" src="{{/js/jquery.validate.min.js"></script>
    <script type="text/javascript" src="{{/js/validation-rule.js"></script>
