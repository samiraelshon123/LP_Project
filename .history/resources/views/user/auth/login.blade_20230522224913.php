...
<head>
    ...
    <script type="text/javascript" src="{{asset('asset/js/jquery-ui.1.10.4.min.js')"}}
    <script type="text/javascript" src="{{asset('asset/js/toastr.min.js')"}}
    <script type="text/javascript" src="{{asset('asset/js/modernizr.js')"}}
</head>
<body>
    <div id="layout">
        <div class="info-head">
