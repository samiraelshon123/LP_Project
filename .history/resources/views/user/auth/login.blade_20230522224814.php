...
<body>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="visible-xs visible-sm">
                            ...
                            <li class="text-right"><a href="changelocation.html"><i class="fa fa-map-marker"></i>
                                    Faridabad, Haryana</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="changelocation.html"><i class="fa fa-map-marker"></i> Faridabad, Haryana</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li class="login-form"> <a href="register.html" title="Register">Register</a></li>
    ...
    <script type="text/javascript" src="{{asset('assets/js/nav/jquery.sticky.js'"
    <script type="text/javascript" src="{{asset('assets/js/totop/jquery.ui.totop.js'"
    <script type="text/javascript" src="{{asset('assets/js/accordion/accordion.js'"
    <script type="text/javascript" src="{{asset('assets/js/rs-plugin/js/jquery.themepunch.tools.min.js'"
    <script type="text/javascript" src="{{asset('assets/js/rs-plugin/js/jquery.themepunch.revolution.min.js'"
    <script type="text/javascript" src="{{asset('assets/js/maps/gmap3.js'"
    <script type="text/javascript" src="{{asset('assets/js/fancybox/jquery.fancybox.js'"
    <script type="text/javascript" src="{{asset('assets/js/carousel/carousel.js'"
    <script type="text/javascript" src="{{asset('assets/js/filters/jquery.isotope.js'"
    <script type="text/javascript" src="{{asset('assets/js/twitter/jquery.tweet.js'"
    <script type="text/javascript" src="{{asset('assets/js/flickr/jflickrfeed.min.js'"
    <script type="text/javascript" src="{{asset('assets/js/theme-options/theme-options.js'"
    <script type="text/javascript" src="{{asset('assets/js/theme-options/jquery.cookies.js'"
    <script type="text/javascript" src="{{asset('assets/js/bootstrap/bootstrap.min.js'"
    <script type="text/javascript" src="{{asset('assets/js/bootstrap/bootstrap-slider.js'"
    <script type="text/javascript" src="{{asset('assets/js/dtb/jquery.dataTables.min.js'"
    <script type="text/javascript" src="{{asset('assets/js/dtb/jquery.table2excel.js'"
    <script type="text/javascript" src="{{asset('assets/js/dtb/script.js'"
    <script type="text/javascript" src="{{asset('assets/js/select2.min.js'"
    <script type="text/javascript" src="{{asset('assets/js/jquery.validate.min.js'"
    <script type="text/javascript" src="{{asset('assets/js/validation-rule.js'"
    <script type="text/javascript" src="{{asset('assets/js/bootstrap3-typeahead.min.js'"
