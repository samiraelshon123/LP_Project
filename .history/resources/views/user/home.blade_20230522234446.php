...
<body>
    <div id="layout">
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    <li class="title">
                        <a href="index.php.html"><img src="{{asset('asset/images/logo.png')}}"></a>
                    </li>
            ...
            <div class="tp-banner">
                <ul>
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                        ...
                        <img src="{{asset('asset//img/slide/1.jpg')}}" alt="fullslide1" data-bgposition="center center"
                            data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130"
                            data-bgfitend="100" data-bgpositionend="right center">
                    </li>
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="1000"
                        data-saveperformance="off" data-title="Slide">
                        <img src="{{asset('asset//img/slide/2.jpg')}}" alt="fullslide1" data-bgposition="top center"
                            data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130"
                            data-bgfitend="100" data-bgpositionend="right center">
                    </li>
                </ul>
        ...
        <section class="content-central">
                        ...
                        <div class="col-md-12">
                            <ul id="sponsors" class="tooltip-hover">
                                <li data-toggle="tooltip" title="" data-original-title="AC"> <a
                                        href="servicesbycategory/1.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="AC"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Beauty"> <a
                                        href="servicesbycategory/2.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Beauty"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Plumbing"> <a
                                        href="servicesbycategory/3.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Plumbing"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Electrical"> <a
                                        href="servicesbycategory/4.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Electrical"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Shower Filter"> <a
                                        href="servicesbycategory/5.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Shower Filter"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Home Cleaning"> <a
                                        href="servicesbycategory/6.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Home Cleaning"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Carpentry"> <a
                                        href="servicesbycategory/7.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Carpentry"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Pest Control"> <a
                                        href="servicesbycategory/8.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Pest Control"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Chimney Hob"> <a
                                        href="servicesbycategory/9.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Chimney Hob"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Water Purifier"> <a
                                        href="servicesbycategory/10.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Water Purifier"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Computer Repair"> <a
                                        href="servicesbycategory/11.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Computer Repair"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="TV"> <a
                                        href="servicesbycategory/12.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="TV"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Refrigerator"> <a
                                        href="servicesbycategory/13.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Refrigerator"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Geyser"> <a
                                        href="servicesbycategory/14.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Geyser"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Car"> <a
                                        href="servicesbycategory/15.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Car"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Document"> <a
                                        href="servicesbycategory/16.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Document"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Movers &amp; Packers"> <a
                                        href="servicesbycategory/17.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
                                            alt="Movers &amp; Packers"></a></li>
                                <li data-toggle="tooltip" title="" data-original-title="Home Automation"> <a
                                        href="servicesbycategory/18.html"><img src="{{asset('asset/images/sercat/service-icon.png')}}"
            ...
            <div class="semiboxshadow text-center">
                <img src="{{asset('asset/assets/img/img-theme/shp.png')}}" class="img-responsive" alt="">
            </div>
                        ...
                        <div class="portfolioContainer" style="margin-top: -50px;">
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="service-details/ac-dry-servicing.html">
                                    <div class="img-hover">
                                        <img src="{{asset('asset/images/services/thumbnails/thumbnail.jpg')}}" alt="AC Dry Servicing"
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="service-details/ac-installation.html">
                                    <div class="img-hover">
                                        <img src="{{asset('asset/images/services/thumbnails/thumbnail.jpg')}}" alt="AC Installation"
                                            class="img-responsive">
                                    </div>
                                    <div class="info-gallery">
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="service-details/ac-gas-top-up.html">
                                    <div class="img-hover">
                                        <img src="{{asset('asset/images/services/thumbnails/thumbnail.jpg')}}" alt="AC Gas Top Up"
                                            class="img-responsive">
                                    </div>
                                    <div class="info-gallery">
                                        <h3>AC Gas Top Up</h3>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="service-details/ac-gas-refill.html">
                                    <div class="img-hover">
                                        <img src="{{asset('asset/images/services/thumbnails/thumbnail.jpg')}}" alt="AC Gas Refill"
                                            class="img-responsive">
                                    </div>
                                    <div class="info-gallery">
                                        <h3>AC Gas Refill</h3>
                                        ...
                                        <a href="servicesbycategory/1.html">
                                            <div class="item-service-line">
                                                <i class="fa"><img class="icon-img"
                                                        src="{{asset('asset/images/sercat/service-icon.png')}}"></i>
                                                <h5>AC</h5>
                                            </div>
                                        </a>
                                    </li>
                ...
                <div id="boxes-carousel">
                    <div>
                        <a class="g-list" href="service-details/ac-wet-servicing.html">
                            <div class="img-hover">
                                <img src="{{asset('asset/images/services/thumbnails/thumbnail.jpg')}}" alt="" class="img-responsive">
                            </div>
    ...
    <script type="text/javascript" src="{{asset('asset/js/nav/jquery.sticky.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/totop/jquery.ui.totop.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/accordion/accordion.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/maps/gmap3.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/fancybox/jquery.fancybox.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/carousel/carousel.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/filters/jquery.isotope.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/twitter/jquery.tweet.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/flickr/jflickrfeed.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/theme-options/theme-options.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/theme-options/jquery.cookies.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/bootstrap/bootstrap.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/bootstrap/bootstrap-slider.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/dtb/jquery.dataTables.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/dtb/jquery.table2excel.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/dtb/script.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('asset/js/validation-rule.js')}}"></script>
    <script type="text/javascript" src="{{asset('asset/js/bootstrap3-typeahead.min.js')}}"></script>
