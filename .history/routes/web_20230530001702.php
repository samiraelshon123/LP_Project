...
Route::group(['middleware' => ['auth']], function() {
    Route::get('/', [UserController::class, 'home'])->name('user.home');SubCategory
    Route::get('categories', [UserController::class, 'categories'])->name('user.categories');
    Route::get('SubCategory', [UserController::class, 'SubCategory'])->name('user.SubCategory');
    ...
    Route::get('services_by_category', [UserController::class, 'services_by_category'])->name('user.services_by_category');
