    ...
    <form action="{{route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="row">
            ...
            <div class="form-group col-6">
                ...
                <input type="text" class="form-control" id="mobile_icon" value="{{old('mobile_icon', $category->mobile_icon)}}" name="mobile_icon" placeholder="Enter Mobile Icon">
            </div>
            <div class="form-group col-6">
              ...
              <div class="form-group col-6">
                ...
                @foreach($categories as $category)
                  <option value="{{$category->id}}" {{($category->sub_category == $category->id)? 'selected': ''}}>{{$category->name}}</option>
                  @endforeach
                </select>            
              </div>
            <div class="form-group col-6">
