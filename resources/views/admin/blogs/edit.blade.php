    ...
    <form action="{{route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-group col-6">
            ...
            <div class="form-group col-6">
                ...
                <input type="text" class="form-control" id="author" value="{{old('author', $blog->author)}}" name="author" placeholder="Enter Author">
            </div>
            <div class="form-group col-6">
                <label for="exampleInputEmail1">Excerpt</label>
                <input type="text" class="form-control" id="excerpt" value="{{old('excerpt', $blog->excerpt)}}" name="excerpt" placeholder="Enter Excerpt">
            </div>
            <div class="form-group col-6">
                <label for="exampleInputEmail1">Views</label>
                <input type="text" class="form-control" id="views" value="{{old('views', $blog->views)}}" name="views" placeholder="Enter Views">
            </div>
            <div class="form-group col-6">
