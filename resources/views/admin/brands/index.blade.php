        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Brand Table</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <tbody>
            <tr>
                ...
                <tr>
                    ...
                    <td>{{ $Brand->title }}</td>
                    <td>{{ $Brand->url }}</td>
                    <td><img src= "{{ $Brand->image_for_web }}" style="width: 120px; height: 120px;" class="w-50p"/></td>

                    <td style="display: flex;border-bottom: none;">
                        <a class="mr-4" href="{{route('brand.edit', $Brand->id)}}">
